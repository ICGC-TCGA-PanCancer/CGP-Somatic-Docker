...
ln -s $DEST_DIR /home/seqware/Seqware-CGP-SomaticCore/target/Workflow_Bundle_SangerPancancerCgpCnIndelSnvStr_1.0.8_SeqWare_1.1.0/Workflow_Bundle_SangerPancancerCgpCnIndelSnvStr/1.0.8/data
