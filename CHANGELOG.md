...
* an S3 mode where XML/BAMs are read from S3 URLs and the results written back to S3... we have the latter but the former needs to be done -- TODO
...
* Kyle reported and error on cleanup: "Can't delete folder: /datastore/oozie-e706677a-b7ff-4905-90f2-c717ce2622bf/./temp-62eb639e-cf9f-48cf-a2d3-d0ab996aac05"  -- FIXED, I believe this was fixed in 1.0.5.1 hotfix, 
